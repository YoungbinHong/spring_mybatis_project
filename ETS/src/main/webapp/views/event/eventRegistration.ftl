						...
						<table class="table jambo_table bulk_action">
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="2"><input type="text" name="DiscountRate" id="DiscountRate" value="" class="form-control col-md-3">
			...
			<div class="table-responsive">
				<table class="table jambo_table bulk_action">
					...
					<tbody>
						...
						<#else>
								<tr>
									<td colspan="8"><strong>이용권이 존재하지 않습니다.</strong></td>
								</tr>
						</#if>				
					</tbody>
					</table>
