		...
		<div class="row">
                            ...
                            <tbody>
                                ...
                                <tr style="cursor:pointer;">
                                	<#if rMap.fix==1>
	                                    ...
	                                    <td class="even pointer" onclick="fn_view2('${rMap.noticeSeq}')"  id="btView" data-toggle="modal" data-target="#myLargeModal"><span style="color:red">${rMap.noticeTitle!}</span></td>
	                                    <td class="even pointer" onclick="fn_view2('${rMap.noticeSeq}')"  id="btView" data-toggle="modal" data-target="#myLargeModal"><span style="display:inline-block; width:100%; white-space:nowrap; overflow:hidden;text-overflow:ellipsis;color:red">${rMap.noticeContent!}</span></td>
                                	...
                                	<#else>
	                                    ...
	                                    <td class="even pointer" onclick="fn_view2('${rMap.noticeSeq}')"  id="btView" data-toggle="modal" data-target="#myLargeModal"><span style="display:inline-block; width:100%; white-space:nowrap; overflow:hidden;text-overflow:ellipsis;">${rMap.noticeContent!}</span></td>
	                                    <td class="even pointer" onclick="fn_view2('${rMap.noticeSeq}')"  id="btView" data-toggle="modal" data-target="#myLargeModal">${rMap.id!}</td>
	                                    <td class="even pointer" onclick="fn_view2('${rMap.noticeSeq}')"  id="btView" data-toggle="modal" data-target="#myLargeModal">${rMap.viewcnt!}</td>
	                                    <td class="even pointer" onclick="fn_view2('${rMap.noticeSeq}')"  id="btView" data-toggle="modal" data-target="#myLargeModal">${rMap.reserv!}</td>
                                	</#if>
				...
				<div class="col-md-12 col-sm-20 col-xs-20">	
					<nav aria-label="Page navigation example" class="content-center text-center">
						<@pagingTag.Paging url="/notice/notice" pageCount="${pageInfo.pageCount!}" rowCount="${pageInfo.rowCount!}" rowMax="${pageInfo.rowMax!}" nowPage="${pageInfo.nowPage!}" params="searchText=${searchText}&stdate=${stdate}&eddate=${eddate}" />
					</nav>
				</div>
        </div>
        <div class="clearfix"></div>
							...
							<table class="table table-striped jambo_table bulk_action table_vertical">
								<tbody>
									<tr>
										...
										<td><input type="checkbox" id="fix" name="fix" value="1"/>고정</td>
										</div>
									</tr>
									<tr>
