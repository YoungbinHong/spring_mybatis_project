				...
				<table class="table jambo_table bulk_action">
					...
					<tbody>
						<tr class="even pointer">
							...
							<td class="text-center">365일</td>
							<td class="text-center">등록</td>
							<td class="text-center">1,100,000</td>
							<td class="text-center">open 할인</td>
							<td><button type="button" class="btn btn-success btn-sm"
									style="width: 100%;" data-toggle="modal"
									data-target="#setEvent">설정</button></td>
							<td><button type="button" class="btn btn-secondary btn-sm"
									style="width: 100%;" data-toggle="modal"
									data-target="#cancelTicket">해제</button></td>
							<td><button type="button" class="btn btn-secondary btn-sm"
									style="width: 100%;" data-toggle="modal"
									data-target="#deleteTicket">삭제</button></td>
						</tr>
						...
						<tr class="odd pointer">
							...
							<td><button type="button" class="btn btn-success btn-sm"
									style="width: 100%;" data-toggle="modal"
									data-target="#useTicket">등록</button></td>
							<td><button type="button" class="btn btn-secondary btn-sm"
									style="width: 100%;" data-toggle="modal"
									data-target="#deleteTicket">삭제</button></td>
						</tr>
					...
					<div class="container text-center">
						...
						<div class="mt-3">
							<select name="" id="" class="form-control">
								<option value="">OPEN 할인</option>
								<option value="">1</option>
								<option value="">2</option>
							</select>
							<div class="text-center mt-3">
								<button type="button" class="btn btn-secondary btn-sm">이벤트
									해제</button>
							</div>
							<div class="row justify-content-around mt-3">
								<button type="button" class="btn btn-secondary btn-sm col-md-4"
									data-dismiss="modal">취소</button>
								<button type="button" class="btn btn-success btn-sm col-md-4">적용</button>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container text-center">
						...
						<div class="row justify-content-around mt-3">
							<button type="button" class="btn btn-secondary btn-sm"
								data-dismiss="modal" style="width: 100px;">취소</button>
