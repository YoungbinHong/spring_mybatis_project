																...
																<tr id="changeTag">
																	...
																	<td>
																		...
																		<div id="typeBtns" class="input-group row mb-0 text-left">
																			<div style="margin-left:30px; margin-right:40px;"><label id="chk_1" style="margin: 4px;"> <input type="checkbox" class="flat"/> 전체</label></div>
																			<div style="margin-right:40px;"><label id="chk_2" style="margin: 4px;"> <input type="checkbox" class="flat"/> Basic</label></div>
																			<div style="margin-right:40px;"><label id="chk_3" style="margin: 4px;"> <input type="checkbox" class="flat"/> Position</label></div>
																			<div style="margin-right:40px;"><label id="chk_4" style="margin: 4px;"><input type="checkbox" class="flat"/> Reservation</label></div>
																			<div style="margin-right:40px;"><label id="chk_5" style="margin: 4px;"> <input type="checkbox" class="flat"/> Horizontal</label></div>
																			<div style="margin-right:40px;"><label id="chk_6" style="margin: 4px;"> <input type="checkbox" class="flat"/> Trend Line</label></div>
																		</div>
																		...
																		<div id="candleBtns" class="input-group row mb-0 text-left d-none">
																			<div style="margin-left:30px; margin-right:40px;"><label id="chk_1" style="margin: 4px;"> <input type="checkbox" class="flat"> 전체</label></div>
																			<div style="margin-right:40px;"><label id="chk_2" style="margin: 4px;"> <input type="checkbox" class="flat"> 15m</label></div>
																			<div style="margin-right:40px;"><label id="chk_3" style="margin: 4px;"> <input type="checkbox" class="flat"> 30m</label></div>
																			<div style="margin-right:40px;"><label id="chk_4" style="margin: 4px;"> <input type="checkbox" class="flat"> 60m</label></div>
																			<div style="margin-right:40px;"><label id="chk_5" style="margin: 4px;"> <input type="checkbox" class="flat"> 4h</label></div>
																			<div style="margin-right:40px;"><label id="chk_6" style="margin: 4px;"> <input type="checkbox" class="flat"> 1d</label></div>
																		</div>
																...
																<tr>
																	...
																	<td>
																		<div id="typeBtns2" class="input-group row mb-0 text-left">
																			<div style="margin-left:30px; margin-right:40px;"><label style="margin: 4px;"> <input type="checkbox" class="flat"/> 전체</label></div>
																			<div style="margin-right:40px;"><label style="margin: 4px;"> <input type="checkbox" class="flat"/> Long(buy)</label></div>
																			<div style="margin-right:40px;"><label style="margin: 4px;"> <input type="checkbox" class="flat"/> Short(Sell)</label></div>
																		</div>
																	</td>
																</tr>
