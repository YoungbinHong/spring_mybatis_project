    ...
    $SIDEBAR_MENU.find("a").on("click", function (b) {
        ...
        $MENU_TOGGLE.on("click", function () {
            $BODY.hasClass("nav-md")
                ? ($SIDEBAR_MENU.find("li.active ul").hide(), $SIDEBAR_MENU.find("li.active").addClass("active-sm").removeClass("active"), $SITEIMG.attr("src", $SITEIMG.attr("src").replace("_wht", "_row")))
                : ($SITEIMG.attr("src", $SITEIMG.attr("src").replace("_row", "_wht")), $SIDEBAR_MENU.find("li.active-sm ul").show(), $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")),
...
$(".bulk_action1 input").on("ifChecked", function () {
    (checkState1 = ""), $(this).parent().parent().parent().addClass("selected"), countChecked();
}),
    $(".bulk_action1 input").on("ifUnchecked", function () {
        (checkState1 = ""), $(this).parent().parent().parent().removeClass("selected"), countChecked();
    }),
    $(".bulk_action1 input#check-all").on("ifChecked", function () {
        (checkState1 = "all"), countChecked1();
    }),
    $(".bulk_action1 input#check-all").on("ifUnchecked", function () {
        (checkState1 = "none"), countChecked1();
    }),
    $(document).ready(function () {
