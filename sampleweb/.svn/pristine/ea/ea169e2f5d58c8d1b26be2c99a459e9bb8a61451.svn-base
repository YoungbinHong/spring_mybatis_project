...
public final class Str {
	 ...
	 * @return
	 */
	public static boolean contains(String body, String find) {
		return contains(body, find, false);
	}
	/**
	 * @param body
	 * @param find
	 ...
	 * @return
	 */
	public static boolean contains(String body, String find, boolean ifnull) {
		if(isBlank(body)) {
			return false;
		}
		if(isBlank(find)) {
